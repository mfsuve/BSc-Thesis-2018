...
data_path = 'keras-oneshot/omniglot/python/'
...
Xt, y, c = loadimgs('keras-oneshot/omniglot/python/images_background')
print('## images evaluation loading')
Xv, y, c = loadimgs('keras-oneshot/omniglot/python/images_evaluation')
